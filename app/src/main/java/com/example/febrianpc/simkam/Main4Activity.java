...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView isoValue = findViewById(R.id.textView);
        final TextView aperatureValue = findViewById(R.id.textView3);
        final TextView shutterValue = findViewById(R.id.textView4);
        ...
        aperatureSeekbar.setProgress(1);
